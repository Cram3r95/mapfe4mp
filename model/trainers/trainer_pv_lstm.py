...
## Trainer LSTM based Encoder-Decoder Position-Velocity
    ...
    with autocast():
        ...
        if hyperparameters.loss_type_g == "mse" or hyperparameters.loss_type_g == "mse_w":
            ...
            loss = hyperparameters.loss_ade_weight*loss_ade + \
                   ...
                   hyperparameters.loss_ade_rel_weight*loss_ade_rel + \
                   hyperparameters.loss_fde_rel_weight*loss_fde_rel

            losses["G_mse_ade_loss"] = loss_ade.item()
            losses["G_mse_fde_loss"] = loss_fde.item()
            losses["G_mse_ade_rel_loss"] = loss_ade_rel.item()
            losses["G_mse_fde_rel_loss"] = loss_fde_rel.item()
            ...
            loss_ade_rel, loss_fde_rel = calculate_mse_loss(pred_traj_gt_rel, pred_traj_fake_rel, loss_f["mse"])
            loss_ade, loss_fde = calculate_mse_loss(pred_traj_gt, pred_traj_fake, loss_f["mse"])
